cask "hattotto" do
  version "0.1.6"
  sha256 "5b8480db7e73102ba13f7760242dff23efb33b525746cae2b68030d75d0e14a8"

  url "https://github.com/somei-san/hattotto/releases/download/v#{version}/Hattotto_0.1.6_universal.dmg"
  name "Hattotto"
